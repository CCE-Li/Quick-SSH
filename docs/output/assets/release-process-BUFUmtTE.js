import{n as e}from"./vendor-CQh2k-GV.js";import{n as t}from"./react-vendor-6GaKtW3l.js";var n=t();function r(t){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,pre:`pre`,span:`span`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e(),...t.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.hr,{}),`
`,(0,n.jsx)(r.p,{children:`title: 发布流程\r
description: Quick-SSH 的版本发布流程，包含 GitHub Actions 自动构建和包管理器配置更新。\r
keywords:`}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:`发布`}),`
`,(0,n.jsx)(r.li,{children:`release`}),`
`,(0,n.jsx)(r.li,{children:`github actions`}),`
`,(0,n.jsx)(r.li,{children:`ci/cd`}),`
`,(0,n.jsx)(r.li,{children:`版本`}),`
`]}),`
`,(0,n.jsx)(r.hr,{}),`
`,(0,n.jsx)(r.h1,{id:`发布流程`,children:`发布流程`}),`
`,(0,n.jsx)(r.p,{children:`Quick-SSH 使用 GitHub Actions 自动构建跨平台二进制并发布到 GitHub Release。`}),`
`,(0,n.jsx)(r.h2,{id:`发布流程图`,children:`发布流程图`}),`
`,(0,n.jsx)(r.pre,{language:`txt`,children:(0,n.jsx)(r.code,{language:`txt`,children:`打 git tag v*\r
     ↓\r
GitHub Actions 自动构建\r
     ↓\r
生成各平台归档 + SHA256\r
     ↓\r
上传到 GitHub Release\r
     ↓\r
运行 update-packaging.ps1\r
     ↓\r
更新 packaging 目录下所有包管理器配置\r
     ↓\r
提交到各包管理器仓库
`})}),`
...
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-foreground)`},children:`version `}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-keyword)`},children:`=`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string-expression)`},children:` "2.0.4"`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-comment)`},children:`  # 示例：发布 v2.0.4`})]})]})})}),`
...
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`git`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` commit`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` -m`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string-expression)`},children:` "chore: release v2.0.4"`})]}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`git`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` tag`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` v2.0.4`})]}),`
...
`,(0,n.jsx)(r.li,{children:`根据提交记录自动生成 Release notes`}),`
`,(0,n.jsx)(r.li,{children:`自动更新并推送 CCE-Li/scoop-bucket`}),`
`]}),`
...
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`mkdir`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` -p`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/qssh-x86_64-windows`})]}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`cp`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` target/release/qssh.exe`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/qssh-x86_64-windows/`})]}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`cp`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` target/release/qssh-uploader.exe`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/qssh-x86_64-windows/`})]}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`cp`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` LICENSE`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` README.md`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/qssh-x86_64-windows/`})]}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`cd`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-punctuation)`},children:` &&`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:` zip`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` -r`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` qssh-x86_64-windows.zip`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` qssh-x86_64-windows/`})]}),`
`,(0,n.jsx)(r.span,{className:`line`}),`
`,(0,n.jsx)(r.span,{className:`line`,children:(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-comment)`},children:`# 3. 创建 GitHub Release`})}),`
`,(0,n.jsxs)(r.span,{className:`line`,children:[(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-function)`},children:`gh`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` release`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` create`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` v2.0.4`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/*.zip`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` dist/*.tar.gz`}),(0,n.jsx)(r.span,{style:{color:`var(--shiki-token-string)`},children:` --generate-notes`})]}),`
`,(0,n.jsx)(r.span,{className:`line`}),`
