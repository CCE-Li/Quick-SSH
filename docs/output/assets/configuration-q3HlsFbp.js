import{n as e}from"./vendor-CQh2k-GV.js";import{n as t}from"./react-vendor-6GaKtW3l.js";var n=t();function r(t){let r={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,hr:`hr`,li:`li`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...e(),...t.components},{Callout:i,Note:o,Properties:s,Property:c,Warning:l}=r;return i||a(`Callout`,!0),o||a(`Note`,!0),s||a(`Properties`,!0),c||a(`Property`,!0),l||a(`Warning`,!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.hr,{}),`
`,(0,n.jsx)(r.p,{children:`title: 配置说明\r
...
`,(0,n.jsx)(r.p,{children:`Quick-SSH 将数据分为三类：标准 OpenSSH 格式的主机配置、系统安全凭据库中的密码，以及预留的 JSON 程序设置。`}),`
`,(0,n.jsx)(r.h2,{id:`ssh-配置-sshconfig`,children:`SSH 配置 (~/.ssh/config)`}),`
`,(0,n.jsxs)(r.p,{language:`txt`,children:[`Quick-SSH 的主机连接配置保存在 `,(0,n.jsx)(r.code,{language:`txt`,children:`~/.ssh/config`}),` 文件中，使用标准 OpenSSH 格式。登录密码不写入此文件。`]}),`
...
`,(0,n.jsx)(r.h2,{id:`系统安全凭据库`,children:`系统安全凭据库`}),`
`,(0,n.jsxs)(r.p,{children:[`TUI 编辑器中的 `,(0,n.jsx)(r.strong,{children:`Password`}),` 字段使用操作系统提供的安全存储：`]}),`
`,(0,n.jsxs)(r.table,{children:[(0,n.jsx)(r.thead,{children:(0,n.jsxs)(r.tr,{children:[(0,n.jsx)(r.th,{children:`平台`}),(0,n.jsx)(r.th,{children:`存储后端`})]})}),(0,n.jsxs)(r.tbody,{children:[(0,n.jsxs)(r.tr,{children:[(0,n.jsx)(r.td,{children:`Windows`}),(0,n.jsx)(r.td,{children:`Credential Manager`})]}),(0,n.jsxs)(r.tr,{children:[(0,n.jsx)(r.td,{children:`macOS`}),(0,n.jsx)(r.td,{children:`Keychain`})]}),(0,n.jsxs)(r.tr,{children:[(0,n.jsx)(r.td,{children:`Linux`}),(0,n.jsx)(r.td,{children:`Secret Service / keyutils`})]})]})]}),`
`,(0,n.jsxs)(r.p,{language:`txt`,children:[`凭据以服务名 `,(0,n.jsx)(r.code,{language:`txt`,children:`quick-ssh`}),` 和主机别名为键保存。编辑主机别名时凭据会迁移，删除主机时会同步清理。密码不会出现在 `,(0,n.jsx)(r.code,{language:`txt`,children:`~/.ssh/config`}),`、导出 JSON 或日志中。`]}),`
`,(0,n.jsx)(r.p,{children:`连接时，Quick-SSH 将自身配置为 OpenSSH 的 AskPass 程序。OpenSSH 仍会优先尝试密钥和 ssh-agent；只有提示登录密码时才会读取对应别名的凭据。私钥口令、主机指纹确认和其他交互提示不会被自动处理。`}),`
`,(0,n.jsx)(l,{children:(0,n.jsxs)(r.p,{language:`txt`,children:[`首次连接新主机时，请先执行 `,(0,n.jsx)(r.code,{language:`txt`,children:`ssh <主机别名>`}),` 并手动核对、确认主机指纹。`]})}),`
`,(0,n.jsx)(r.h2,{id:`程序设置-qsshrc`,children:`程序设置 (~/.qsshrc)`}),`
`,(0,n.jsxs)(r.p,{language:`txt`,children:[`Quick-SSH 为程序行为设置预留了 `,(0,n.jsx)(r.code,{language:`txt`,children:`~/.qsshrc`}),` 文件。该文件使用 JSON 格式。`]}),`
...
`,(0,n.jsx)(o,{children:(0,n.jsxs)(r.p,{language:`txt`,children:[`v2.0.4 中 `,(0,n.jsx)(r.code,{language:`txt`,children:`~/.qsshrc`}),` API 已预留，但这些设置尚未接入主要命令流程，将在后续版本中逐步启用。`]})}),`
`,(0,n.jsx)(r.h2,{id:`配置工作原理`,children:`配置工作原理`}),`
`,(0,n.jsx)(r.h3,{id:`配置模块架构`,children:`配置模块架构`}),`
`,(0,n.jsx)(r.p,{children:`配置系统采用类型/解析/渲染分离的设计：`}),`
`,(0,n.jsx)(r.pre,{language:`txt`,children:(0,n.jsx)(r.code,{language:`txt`,children:`SSH 配置文件 (文本)\r
       ↓\r
parser.rs → 文本解析 → types.rs (SshConfig / HostBlock / SshDirective)\r
       ↓\r
