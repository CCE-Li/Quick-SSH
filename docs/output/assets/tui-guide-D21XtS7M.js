...
`]}),`
`,(0,n.jsx)(l,{children:(0,n.jsxs)(r.p,{language:`txt`,children:[`AskPass 只响应登录密码提示，不会自动确认首次连接的主机指纹，也不会填写私钥口令。首次连接请先使用 `,(0,n.jsx)(r.code,{language:`txt`,children:`ssh <主机别名>`}),` 手动确认指纹。`]})}),`
