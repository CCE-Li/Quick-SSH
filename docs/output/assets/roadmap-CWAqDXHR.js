...
`,(0,n.jsx)(r.p,{children:`title: 路线图\r
description: Quick-SSH 的开发路线图，包含当前版本、规划中的功能以及远期规划。\r
keywords:`}),`
...
`,(0,n.jsx)(r.h2,{id:`v204当前版本`,children:`v2.0.4（当前版本）`}),`
...
`,(0,n.jsxs)(r.li,{className:`task-list-item`,language:`txt`,children:[(0,n.jsx)(r.input,{type:`checkbox`,checked:!0,disabled:!0}),` `,(0,n.jsx)(r.code,{language:`txt`,children:`Ctrl+N`}),` / `,(0,n.jsx)(r.code,{language:`txt`,children:`Ctrl+P`}),` 列表导航`]}),`
`,(0,n.jsxs)(r.li,{className:`task-list-item`,language:`txt`,children:[(0,n.jsx)(r.input,{type:`checkbox`,checked:!0,disabled:!0}),` `,(0,n.jsx)(r.code,{language:`txt`,children:`~/.qsshrc`}),` 程序设置 API（功能预留）`]}),`
