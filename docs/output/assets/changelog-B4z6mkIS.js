...
`,(0,n.jsx)(r.p,{children:`title: 变更日志\r
description: Quick-SSH 的版本发布历史记录。\r
keywords:`}),`
...
`,(0,n.jsx)(r.h2,{id:`v204`,children:`v2.0.4`}),`
`,(0,n.jsx)(r.h3,{id:`新增`,children:`新增`}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:`支持在系统凭据库中安全保存主机密码，并通过 OpenSSH AskPass 自动填写`}),`
`,(0,n.jsx)(r.li,{children:`主机编辑表单支持密码和多行注释`}),`
`,(0,n.jsx)(r.li,{children:`支持批量删除已标记主机，并同步清理已保存的密码`}),`
`]}),`
`,(0,n.jsx)(r.h3,{id:`改进`,children:`改进`}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:`主机列表显示首行注释摘要，详情面板支持注释和长文本换行`}),`
`,(0,n.jsx)(r.li,{children:`详情面板显示当前认证方式`}),`
`,(0,n.jsxs)(r.li,{language:`txt`,children:[`新增 `,(0,n.jsx)(r.code,{language:`txt`,children:`Ctrl+N`}),` / `,(0,n.jsx)(r.code,{language:`txt`,children:`Ctrl+P`}),` 列表导航快捷键`]}),`
`]}),`
...
`,(0,n.jsx)(r.h3,{id:`新增-1`,children:`新增`}),`
`,(0,n.jsxs)(r.ul,{children:[`
...
`,(0,n.jsxs)(r.li,{children:[`5 类包管理器配置`,`
`,(0,n.jsxs)(r.ul,{children:[`
