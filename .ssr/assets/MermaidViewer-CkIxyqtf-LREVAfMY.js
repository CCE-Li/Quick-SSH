...
import { g as require_react, h as useBuiltInText, i as ZoomIn, m as clsx, n as require_jsx_runtime, r as ZoomOut, s as Maximize2 } from "../entry-server.js";
//#region node_modules/.pnpm/react-zoom-pan-pinch@4.0.3_react-dom@19.2.7_react@19.2.7__react@19.2.7/node_modules/react-zoom-pan-pinch/dist/index.cjs.js
var require_index_cjs = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	function handleCalculateVelocity(contextInstance, position, device) {
		...
		if (lastMousePosition && velocityTime && wrapperComponent) {
			...
			var sensitivity = (_a = {}, _a[exports.DeviceType.TOUCH] = sensitivityTouch, _a[exports.DeviceType.MOUSE] = sensitivityMouse, _a)[device];
			var maxStrength = (_b = {}, _b[exports.DeviceType.TOUCH] = maxStrengthTouch, _b[exports.DeviceType.MOUSE] = maxStrengthMouse, _b)[device];
	...
	***************************************************************************** */
	...
	var MiniMap = function(_a) {
		...
		return jsxRuntime.jsxs("div", __assign({}, rest, {
			ref: mainRef,
			style: wrapperStyle,
	...
	var TransformComponent = function(_a) {
		...
		return jsxRuntime.jsxs("div", __assign({}, wrapperProps, {
			ref: wrapperRef,
			className: "".concat(baseClasses.wrapperClass, " ").concat(styles.wrapper, " ").concat(wrapperClass),
			style: wrapperStyle
		}, { children: [infinite && jsxRuntime.jsx("div", {
			ref: gridRef,
			className: styles.infiniteGrid,
			"aria-hidden": true
		}), jsxRuntime.jsx("div", __assign({}, contentProps, {
			ref: contentRef,
	...
	*/
	...
	var Virtualize = React.forwardRef(function(_a, ref) {
		...
		if (!visible) return placeholder ? jsxRuntime.jsx(jsxRuntime.Fragment, { children: placeholder }) : null;
...
//#endregion
//#region node_modules/.pnpm/@clarify-labs+renderer@0.11.0_@types+react@19.2.17_react-dom@19.2.7_react@19.2.7__react-route_f7as6ftkxm7zwmx7isv45mpmvm/node_modules/@clarify-labs/renderer/output/MermaidViewer-CkIxyqtf.js
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
var import_index_cjs = require_index_cjs();
function ZoomControls() {
	const { zoomIn, zoomOut, resetTransform } = (0, import_index_cjs.useControls)();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "clarify-mermaid-controls absolute top-2 right-2 z-10 flex gap-1 opacity-0 transition group-hover:opacity-100 focus-within:opacity-100",
		children: [
...
function MermaidViewer(arg0) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_index_cjs.TransformWrapper, {
			minScale: .5,
			maxScale: 8,
			initialScale: 1,
			centerOnInit: true,
			...
			wheel: {
				step: .05,
				wheelDisabled: !focused,
				touchPadDisabled: !focused
			},
			doubleClick: { mode: "reset" },
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ZoomControls, {}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_index_cjs.TransformComponent, {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: clsx("clarify-mermaid-hint pointer-events-none absolute bottom-2 left-1/2 z-10 -translate-x-1/2 rounded-full bg-(--clarify-theme-tokens-colors-surface)/90 px-2.5 py-1 text-2xs text-(--clarify-ui-text-soft) shadow-xs ring-1 ring-(--clarify-theme-tokens-colors-border) backdrop-blur-sm transition", focused ? "opacity-0" : "opacity-0 group-hover:opacity-100"),
					children: t("mermaid.scrollHint")
				})
			]
		})
	});
...
//#endregion
export { MermaidViewer, MermaidViewer as default };
